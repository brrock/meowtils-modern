...
Minecraft 26.2 / Java 25 source port of `Notifications1.1.meowtils`, originally by **Mega**. Recovered from the user-supplied archive; original behavior, UI layout constants and bundled assets are retained where applicable.

Original Tenacity 5.0 and Vape V4 styles, Y offset and Test notifications button. Enabled by default.
...
```sh
./gradlew :notifications:meowtilsArchive
```

Output: `examples/notifications/build/libs/notifications.meowtils`.
